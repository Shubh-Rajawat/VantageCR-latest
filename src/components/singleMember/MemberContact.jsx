...
import "../ask_an_agent/askAgent.css";
...
const MemberContact = ( { agentemail } ) => {
  // ask get api
  ...
  const handleSubmit = ( event ) => {
    ...
    if ( recaptchaValue ) {
      axios
        .post( `${ BaseUrl }api/ourteam-message`, { ...user, agent_email: agentemail } )
        .then( ( res ) => {
        ...
        <div className="col-lg-6 p-0 ask-content py-5 py-lg-0">
          ...
          >
            <div className="ask-heading">
              <h1 className="dropFont" style={ { color: "#5C727D" } }>
                Drop a Message
              </h1>
              <p className=""
                style={ {
              ...
              >We’re here to help seven days a week.</p>
            </div>
            <div>
